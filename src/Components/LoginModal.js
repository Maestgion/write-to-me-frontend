            ...
            <button className='relative left-[29vw] bottom-[22vh]' onClick={handleOnClick}>
                ...
                {/* Modal div */}
                    ...
                    className='w-[30vw] h-[50vh] border rounded-xl flex flex-col gap-10 items-center justify-center px-8 bg-gray-400  backdrop-filter backdrop-blur-sm bg-opacity-10 -z-10 text-white'>
                        ...
                        <input type="email"  placeholder="Your Email" className='py-3 px-8 outline-none  min-w-full rounded-xl bg-gray-400 placeholder-white caret-white'
                        name='email'
                        value={inputs.email}
                        onChange={handleInputs} />
                        
                        <input type="password"  placeholder="Password" className='py-3 px-8 outline-none bg-gray-400 placeholder-white min-w-full rounded-xl caret-white'
                         name='password'
                         value={inputs.password}
                         onChange={handleInputs} />

                    
              <button type='submit' className='rounded-xl bg-gray-400 min-w-[12vw]  hover:bg-[#0F172A]'>
